...
<html lang="en">
    <head>
        ...
        <!-- Fontawesome CSS -->
        <link rel="stylesheet" href="asset\library\vendor\@fortawesome\fontawesome-free\css\all.min.css">
    ...
    <body data-spy="scroll" data-target="#navbarSupportedContent" data-offset="30">
        ...
        <header class="gradient-bg" id="home">
            <div class="container mt-5">
                <div>
                    <div class="content">
                        <h1 style="color: #02005C;">PT. KETWOOO</h1>
                        <p>Sistem Informasi Penggajian Karyawan (SIPK) 
